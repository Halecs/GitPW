...
<?php
  ...
  if(strcmp($empleado['Sexo'],"Hombre") == 0)
  {
    $Hcheck="checked";
    $Mcheck="";
    $Ocheck="";
  ...
  {
    if(strcmp($empleado['Sexo'],"Mujer") == 0)
    {
      $Hcheck="";
      $Mcheck="checked";
      $Ocheck="";
  ...
  if(strcmp($empleado['Departamento'],"Recursos Humanos") == 0)
  {
    $depart['r'] = "checked";
  }
  else
  {
    if(strcmp($empleado['Departamento'],"Finanzas") == 0)
    {
      $depart['f'] = "checked";
    }
    else
    {
      if(strcmp($empleado['Departamento'],"Asistencia Tecnica") == 0)
      {
        $depart['a'] = "checked";
      }
      else
...
<fieldset class="form-group">
    ...
    <div class="form-check form-check-inline">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="sexo" id="optionsRadios1" value="Hombre" $Hcheck>
        	Hombre
      </label>
    </div>
    <div class="form-check form-check-inline">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="sexo" id="optionsRadios2" value="Mujer" $Mcheck>
        Mujer
      </label>
    </div>
    <div class="form-check form-check-inline">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="sexo" id="optionsRadios3" value="Otro" $Ocheck>
        Otro
      </label>
    </div>
  </fieldset>
...
<fieldset class="form-group">
    ...
    <div class="form-check form-check-inline">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="departamento" id="RRHH" value="Recursos Humanos" $depart[r]>
        Recursos humanos
      </label>
    </div>
    <div class="form-check form-check-inline">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="departamento" id="AT" value="Asistencia Tecnica" $depart[a]>
        Atencion al cliente
      </label>
    </div>
    <div class="form-check form-check-inline">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="departamento" id="Finanzas" value="Finanzas" $depart[f]>
        Finanzas
      </label>
    </div>
    <div class="form-check form-check-inline">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="departamento" id="MF" value="Manufactura" $depart[m]>
        Manufactura
      </label>
    </div>
  </fieldset>
